...
export default async function TermsPage({ params }: PageProps) {
  ...
  const items = t.raw("legal.termsItems") as string[];
    ...
    <>
      <JsonLd
        data={breadcrumbSchema(
          [
            ...
            { name: t("meta.termsTitle"), href: "/terms" }
          ],
          locale
        )}
      />
      <Breadcrumbs
        items={[
          ...
          { label: t("meta.termsTitle"), href: "/terms" }
        ]}
      />
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <p className="mt-6 text-xl leading-8 text-slate-700">{t("legal.termsIntro")}</p>
